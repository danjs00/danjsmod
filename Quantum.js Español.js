...
// @downloadURL https://update.greasyfork.org/scripts/483164/Quantumjs.user.js
// @updateURL https://update.greasyfork.org/scripts/483164/Quantumjs.meta.js
// ==/UserScript==
...
(function() {
    let version = 2;
    let cversion = 2;
    let storageName = "SigModClient-settings"; // SigMod Client --> Cursed Config
            ...
            const reset = (type) => {
                ...
                switch (type) {
                    ...
                    case 'skin':
                        ...
                        if (confirm("Actualice la página para que funcione. ¿Recargar?")) {
                            location.reload();
                        }
                        break;
                    case 'virus':
                          ...
                          <div class="mod_menu_content">
                            <div class="mod_tab" id="mod_home">
                                ...
                                <div class="justify-sb">
                                    <div class="mod_player-stats">
                                        <span class="justify-sb" style="font-size:17px;font-style:italic; font-weight:400;">ㆍ Tus estadísticas:</span>
                                        <div class="player-stats-grid">
                                            <div class="player-stat">
                                                <span style="margin-right:-6px"><svg width="15" fill="#fff" style="position:absolute; left:16.6rem; top:14.6rem;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120V256c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2V120c0-13.3-10.7-24-24-24s-24 10.7-24 24z"/></svg>Jugaste</span>
                                                <span id="stat-time-played">0h 0m</span>
                                            </div>
                                            <div class="player-stat" style="margin-left:-3px;">
                                                <span style="margin-right:-20px"><svg width="16" fill="#fff" style="position:absolute; left:31.2rem; top:14.3rem;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M159.3 5.4c7.8-7.3 19.9-7.2 27.7 .1c27.6 25.9 53.5 53.8 77.7 84c11-14.4 23.5-30.1 37-42.9c7.9-7.4 20.1-7.4 28 .1c34.6 33 63.9 76.6 84.5 118c20.3 40.8 33.8 82.5 33.8 111.9C448 404.2 348.2 512 224 512C98.4 512 0 404.1 0 276.5c0-38.4 17.8-85.3 45.4-131.7C73.3 97.7 112.7 48.6 159.3 5.4zM225.7 416c25.3 0 47.7-7 68.8-21c42.1-29.4 53.4-88.2 28.1-134.4c-4.5-9-16-9.6-22.5-2l-25.2 29.3c-6.6 7.6-18.5 7.4-24.7-.5c-16.5-21-46-58.5-62.8-79.8c-6.3-8-18.3-8.1-24.7-.1c-33.8 42.5-50.8 69.3-50.8 99.4C112 375.4 162.6 416 225.7 416z"/></svg>Masa max.</span>
                                                <span id="stat-highest-mass">0</span>
                                            </div>
                                            <div class="player-stat" style="background:#66E204;color:#000;">
                                                <span style="margin-right:-18px;"><svg width="15" fill="#000" style="position:absolute; left:16.5rem; top:22.6rem;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M416 398.9c58.5-41.1 96-104.1 96-174.9C512 100.3 397.4 0 256 0S0 100.3 0 224c0 70.7 37.5 133.8 96 174.9c0 .4 0 .7 0 1.1v64c0 26.5 21.5 48 48 48h48V464c0-8.8 7.2-16 16-16s16 7.2 16 16v48h64V464c0-8.8 7.2-16 16-16s16 7.2 16 16v48h48c26.5 0 48-21.5 48-48V400c0-.4 0-.7 0-1.1zM96 256a64 64 0 1 1 128 0A64 64 0 1 1 96 256zm256-64a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/></svg>Has muerto</span>
                                ...
                                <div class="justify-sb" style="gap: 18px;">
                                    <div class="f-column w-100" style="gap: 5px;margin-top:5px;">
                                        <span style="font-size:17px;font-style:italic; font-weight:400;">ㆍ Acceso rápido</span>
                                        <div class="quickAccess scroll" id="mod_qaccess"></div>
                                    </div>
                                    <div class="modProfileWrapper">
                                        <span style="font-size:17px;font-style:italic; font-weight:400;margin-left-5px;margin-top:5px;">ㆍ Perfil del Mod</span>
                                        <div class="modUserProfile">
                                            <div class="justify-sb" style="margin-bottom:10px;">
                                                 <div class="flex" style="align-items: center; gap: 5px;">
                                                    ...
                                                    <span id="my-profile-role" style="display:flex;position: absolute;top: 36.4rem;left: 46.2rem;font-size: 14px;">Espectador</span>
                                                </div>
                                            ...
                                            <hr />
                                            <span id="my-profile-bio">Notas o descripción</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="mod_tab scroll" id="mod_macros" style="display: none">
                                    ...
                                    <div class="macros_wrapper">
                                        <span class="text-center">Atajos de teclado</span>
                                        ...
                                        <div style="justify-content: center;">
                                            <div class="f-column g-10" style="align-items: center; justify-content: center;">
                                                ...
                                                <label class="macroRow">
                                                  <span class="text">Mostrar Menu</span>
                                     ...
                                     <div class="macros_wrapper" style="margin-bottom: 10px;padding-bottom:10px;">
                                        <span class="text-center" style="font-size: 17px; margin-top: 5px;">Opciones Avanzadas</span>
                                        <div class="setting-card-wrapper">
                                            ...
                                            <div class="setting-parameters" style="display: none;">
                                                <div class="my-5">
                                                    <span class="stats-info-text">Alimentar o dividir con los botones del mouse</span>
                                                </div>
                                        ...
                                        <div class="setting-card-wrapper">
                                            <div class="setting-card">
                                                <div class="setting-card-action">
                                                    <span class="setting-card-name">Congelar jugador</span>
                                                </div>
                                            </div>

                                            <div class="setting-parameters" style="display: none;">
                                                <div class="my-5">
                                                    <span class="stats-info-text">Congelate en el mapa y divide las líneas.</span>
                                                </div>

                                                <div class="stats-line justify-sb">
                                                    <span class="cconfig">Tipo de congelación</span>
                                                    <select class="form-control" style="padding: 2px; text-align: left; width: 100px" id="freezeType">
                                                        <option value="press">Presionar</option>
                                                        <option value="hold">Sostener</option>
                                                    </select>
                                                </div>

                                                <div class="stats-line justify-sb">
                                                    <span style="margin-left:3px;">Efectuar comando con</span>
                                        ...
                                        <div class="setting-card-wrapper">
                                            <div class="setting-card">
                                                <div class="setting-card-action">
                                                    <span class="setting-card-name">Alternar configuración</span>
                                                </div>
                                            </div>

                                            <div class="setting-parameters" style="display: none;">
                                                <div class="my-5">
                                                    <span class="stats-info-text">Alternar configuración con atajos</span>
                                                </div>

                                                <div class="stats-line justify-sb">
                                                    <span style="margin-right:2px;margin-left:2px;">Mostrar/Ocultar nombres</span>
                                                ...
                                                <div class="stats-line justify-sb">
                                                    <span style="margin-right:2px;margin-left:2px;">Mostrar/Ocultar Skins</span>
                                                ...
                                                <div class="stats-line justify-sb">
                                                <span style="margin-right:2px;margin-left:2px;">Alternar Autorespawn</span>
                                        ...
                                        <div class="setting-card-wrapper">
                                            ...
                                            <div class="setting-parameters" style="display: none;">
                                                <div class="my-5">
                                                    <span class="stats-info-text">Otras opciones de división</span>
                                                </div>
                                                <div class="stats-line justify-sb">
                            ...
                            <div class="mod_tab scroll" id="mod_game" style="display: none">
                                <div class="modColItems">
                                    <div class="modRowItems">
                                        <div class="modItem">
                                            <span class="text" style="font-size:13px;">Color del mapa</span>
                                            <div class="centerXY">
                                        ...
                                        <div class="modItem">
                                            <span class="text" style="font-size:13px;">Color de borde</span>
                                            <div class="centerXY">
                                        ...
                                        <div class="modItem">
                                            <span class="text" style="font-size:13px;">Color de masa</span>
                                            <div class="centerXY">
                                        ...
                                        <div class="modItem">
                                            <span class="text" style="font-size:13px;">Color de celula</span>
                                            <div class="centerXY">
                                    ...
                                    <div class="modRowItems justify-sb" style="background:#121212;">
                                        <span class="text">Posicion de pantalla al morir</span>
                                    ...
                                    <div class="modRowItems justify-sb" style="background: #66E204;color: #000;>
                                        <span class="text">Temporizador de juego</span>
                                    ...
                                    <div class="modRowItems justify-sb">
                                        <span class="text">Reiniciar Configuración</span>
                                        <button class="modButton-secondary" id="resetModSettings" type="button">Config del Mod</button>
                                        <button class="modButton-secondary" id="resetGameSettings" type="button">Config del Juego</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mod-small-modal" id="virusModal" style="display: none;">
                                <div class="mod-small-modal-header">
                                    <h1 style="font-size:16px;color:#fff"><svg style="width:20px;margin-left:143px;position:absolute;margin-bottom:7px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#ffffff" d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zm0-384c13.3 0 24 10.7 24 24V264c0 13.3-10.7 24-24 24s-24-10.7-24-24V152c0-13.3 10.7-24 24-24zM224 352a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z"/></svg>Imagen del Virus</h1>
                                ...
                                <div class="mod-small-modal-content">
                                    <div class="mod-small-modal-content_selectImage">
                                        <div class="flex" style="gap: 5px;">
                                            <input type="text" class="modInput" placeholder="URL del virus" id="virusURL" value="${virusImgVal()}" />
                                            <button class="modButton" id="setVirus">Subir</button>
                                        </div>
                                    </div>
                                    <button class="modButton" id="resetVirus" style="align-self: start; margin-top: 5px;">Reiniciar</button>
                            ...
                            <div class="mod-small-modal" id="skinModal" style="display: none;">
                                <div class="mod-small-modal-header">
                                    <h1 style="font-size:16px;color:#fff"><svg style="width:20px;margin-left:139px;position:absolute;margin-bottom:7px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#ffffff" d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zm0-384c13.3 0 24 10.7 24 24V264c0 13.3-10.7 24-24 24s-24-10.7-24-24V152c0-13.3 10.7-24 24-24zM224 352a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z"/></svg>Remplazar Skins</h1>
                                ...
                                <div class="mod-small-modal-content">
                                    <div class="mod-small-modal-content_selectImage">
                                        <div class="centerXY" style="gap: 5px;">
                                            <span>Skin Original: </span>
                                            <select class="form-control" style="padding: 2px; text-align: left; width: fit-content" id="originalSkinSelect"></select>
                                        </div>
                                        <span style="text-align: center">Será remplazado por</span>
                                        <div class="flex" style="gap: 5px;">
                                            <input type="text" class="modInput" placeholder="URL de la Skin" id="skinURL" value="${skinImgVal()}"/>
                                            <button class="modButton" id="setSkin">Subir</button>
                                        </div>
                                    </div>
                                    <button class="modButton" id="resetSkin" style="align-self: start; margin-top: 5px;">Reiniciar</button>
                            ...
                            <div class="modColItems">
                                ...
                                <div class="modRowItems justify-sb" style="gap:28px;">
                                    <div class="f-column g-5">
                                        <span class="modTitleText" style="margin-left:10px;">Guardar nombres</span>
                                        <span class="modDescText" style="margin-left:10px;">Guardar nombres localmente</span>
                                        <div class="flex g-5">
                                            <input class="modInput" placeholder="Escribe un nombre" id="saveNameValue" style="margin-left:10px;" />
                                    ...
                                    <div class="vr"></div>
                                    <div class="f-column g-5">
                                         <span class="modTitleText">Color de nombre</span>
                                        <span class="modDescText">Personaliza el color de tu nombre que quieres ver en el juego</span>
                                        <div class="justify-sb">
                                            <input type="color" value="#ffffff" id="nameColor" class="colorInput">
                                            <span class="modTitleText" style="color:#fff;margin-left: -50px;">Elegir color</span>
                                            <button class="resetButton" id="nameColorReset"></button>
                                        </div>
                                        <span class="modDescText">Personaliza los colores para el degradado de tu nombre</span>
                                        <div class="justify-sb">
                                            <div class="flex g-2" style="align-items: center">
                                                <input type="color" value="#ffffff" id="gradientNameColor1" class="colorInput">
                                                <span style="color:#fff">‎ ‎ Primer color</span>
                                            </div>
                                        ...
                                        <div class="justify-sb">
                                            <div class="flex g-2" style="align-items: center">
                                                ...
                                                <span style="color:#fff">‎ ‎ Segundo color</span>
                                            </div>
                            ...
                            <div class="mod_tab scroll" id="mod_themes" style="display: none">
                                <div class="themes scroll" id="themes">
                                    <div class="theme" id="createTheme">
                                        ...
                                        <div class="themeName text" style="color: #fff">Crear</div>
                                    </div>
                                </div>
                            </div>
                            <div class="mod_tab scroll" id="mod_fps" style="display: none">
                                ...
                                <div class="modRowItems justify-sb" style="background:#121212;">
                                    <span style="color:#fff;">Ocultar comida</span>
                                    <div class="modCheckbox">
                                ...
                                <div class="modRowItems justify-sb" style="background:#121212;">
                                    <span style="color:#fff;">Mostrar nombres</span>
                                    <div class="modCheckbox">
                                ...
                                <div class="modRowItems justify-sb" style="background:#121212;">
                                    <span style="color:#fff;">Acortar nombres largos</span>
                                    <div class="modCheckbox">
                                ...
                                <div class="modRowItems justify-sb" style="background:#121212;">
                                    <span style="color:#fff;">Remover sombra de texto</span>
                                    <div class="modCheckbox">
                            ...
                            <div class="modRowItems" style="background: #121111;height: 50px;">
                                    ...
                                    <div class="modRowItems" style="background: #121111;height: 50px;">
                                        <div class="modItem">
                                            <a href="" style="color:#fff;" title='Translate Mod'><span class="text"><svg fill="#4d91ff" width="14" style="margin-right:6px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><title>Translate Mod</title><path d="M349.4 44.6c5.9-13.7 1.5-29.7-10.6-38.5s-28.6-8-39.9 1.8l-256 224c-10 8.8-13.6 22.9-8.9 35.3S50.7 288 64 288H175.5L98.6 467.4c-5.9 13.7-1.5 29.7 10.6 38.5s28.6 8 39.9-1.8l256-224c10-8.8 13.6-22.9 8.9-35.3s-16.6-20.7-30-20.7H272.5L349.4 44.6z"/></svg>English</span></a>
                                            <div class="centerXY">
                                            </div>
                                        </div>
                                        <div class="modItem">
                                            <a href="" style="color:#fff;" title='Translate page'><span class="text"><svg fill="#4d91ff" width="14" style="margin-right:6px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><title>Translate Mod</title><path d="M349.4 44.6c5.9-13.7 1.5-29.7-10.6-38.5s-28.6-8-39.9 1.8l-256 224c-10 8.8-13.6 22.9-8.9 35.3S50.7 288 64 288H175.5L98.6 467.4c-5.9 13.7-1.5 29.7 10.6 38.5s28.6 8 39.9-1.8l256-224c10-8.8 13.6-22.9 8.9-35.3s-16.6-20.7-30-20.7H272.5L349.4 44.6z"/></svg>Spanish</span></a>
                                            <div class="centerXY">
                                             </div>
                                        </div>
                                        <div class="modItem">
                                            <a href="" style="color:#fff;" title='Translate page'><span class="text"><svg fill="#4d91ff" width="14" style="margin-right:6px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><title>Translate Mod</title><path d="M349.4 44.6c5.9-13.7 1.5-29.7-10.6-38.5s-28.6-8-39.9 1.8l-256 224c-10 8.8-13.6 22.9-8.9 35.3S50.7 288 64 288H175.5L98.6 467.4c-5.9 13.7-1.5 29.7 10.6 38.5s28.6 8 39.9-1.8l256-224c10-8.8 13.6-22.9 8.9-35.3s-16.6-20.7-30-20.7H272.5L349.4 44.6z"/></svg>Russian</span></a>
                                            <div class="centerXY">
                                             </div>
                                        </div>
                                        <div class="modItem">
                                            <a href="" style="color:#fff;" title='Translate page'><span class="text"><svg fill="#4d91ff" width="14" style="margin-right:6px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><title>Translate Mod</title><path d="M349.4 44.6c5.9-13.7 1.5-29.7-10.6-38.5s-28.6-8-39.9 1.8l-256 224c-10 8.8-13.6 22.9-8.9 35.3S50.7 288 64 288H175.5L98.6 467.4c-5.9 13.7-1.5 29.7 10.6 38.5s28.6 8 39.9-1.8l256-224c10-8.8 13.6-22.9 8.9-35.3s-16.6-20.7-30-20.7H272.5L349.4 44.6z"/></svg>Turkish</span></a>
                                            <div class="centerXY">
                                             </div>
                                        </div>
                                    </div>
                                       <div class="Tutorial" onclick="window.open('https://www.youtube.com/@sigmallyCursed')">
                                        ...
                                        <span style="font-size: 15px;color:#fff;">Mirar tutorial</span>
                                    </div>
                             ...
                             <div class="mod_tab scroll f-column g-5 text-center" id="mod_info" style="display: none">
                                ...
                                <button class="modButton p_s_n" onclick="window.open('https://github.com/danjs00/Quantum.js/blob/main/privacy_security.md')">Términos de privacidad y seguridad / GitHub</button>
                                <div class="brand_yt">
...
<a href="https://beta.sigmally.com/" style="display: inline-block; margin-top: 10px; margin-left: 15px;">
    <img height="150" width="240" style="border-radius: 10px; cursor: pointer; object-fit: contain;" src="https://i.ibb.co/hHXcRbG/Insanity-Family-5.png" alt="image" />
            ...
            resetModSettings.addEventListener("click", () => {
                if (confirm("¿Estás seguro de que quieres restablecer la configuración del mod? Se requiere una recarga.")) {
            ...
            resetGameSettings.addEventListener("click", () => {
                if (confirm("¿Estás seguro de que quieres restablecer la configuración del juego? Tu nick y más configuraciones se perderán. Se requiere una recarga.")) {
    ...
    border-top: 1px solid #eee;" />
                <main class="theme_editor_content">
                    <div class="centerXY" style="justify-content: flex-end;gap: 10px">
                        <span class="text">Elegir tipo de tema: </span>
                    ...
                    <div id="theme_editor_color" class="theme-editor-tab">
                        <div class="centerXY">
                            <label for="theme-editor-bgcolorinput" class="text">Color de fondo:</label>
                            <input type="color" value="#000000" class="colorInput whiteBorder_colorInput" id="theme-editor-bgcolorinput"/>
                        </div>
                        <div class="centerXY">
                            <label for="theme-editor-colorinput" class="text">Color de texto:</label>
                        ...
                        <div class="centerY" style="gap: 10px; margin-top: 10px;">
                            <input type="text" class="form-control" style="background: #222; color: #fff;" maxlength="15" placeholder="Nombre del tema..." id="colorThemeName"/>
                            <button class="btn btn-success" id="saveColorTheme">Guardar</button>
                        </div>
                    </div>
                    ...
                    <div id="theme_editor_gradient" class="theme-editor-tab" style="display: none;">
                        ...
                        <div class="centerXY">
                            <label for="theme-editor-gcolor2" class="text">Color de texto:</label>
                        ...
                        <div class="centerXY" style="gap: 10px">
                            <label for="gradient-type" class="text">Tipo de gradiente:</label>
                        ...
                        <div class="centerY" style="gap: 10px; margin-top: 10px;">
                            <input type="text" class="form-control" style="background: #222; color: #fff;" placeholder="Nombre del tema..." id="GradientThemeName"/>
                            <button class="btn btn-success" id="saveGradientTheme">Guardar</button>
                        </div>
                    </div>
                    ...
                    <div id="theme_editor_image" class="theme-editor-tab" style="display: none">
                        <div class="centerXY">
                            <input type="text" id="theme-editor-imagelink" placeholder="Imagen / GIF URL (https://i.ibb.co/ryByLxF/Black-White-Modern-Luxury-Logo-34.png)" class="form-control" style="background: #222; color: #fff"/>
                        </div>
                        <div class="centerXY" style="margin: 5px; gap: 5px;">
                            <label for="theme-editor-textcolorImage" class="text">Color de texto: </label>
                        ...
                        <div class="centerY" style="gap: 10px; margin-top: 10px;">
                            <input type="text" class="form-control" style="background: #222; color: #fff;" placeholder="Nombre del tema..." id="imageThemeName"/>
                            <button class="btn btn-success" id="saveImageTheme">Guardar</button>
                        </div>
                    </div>
                </main>
            `;
...
<svg fill="#fff" width="26" style="margin-top:5px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z"/></svg>
                       ...
                       <input type="text" id="chatSendInput" class="chatInput" placeholder="↪ Escribe aquí..." maxlength="260" minlength="1" />
            ...
            party.addEventListener("click", () => {
                ...
                if (!modSettings.tag) {
                    modMessages.innerHTML = `
                        <div class="message">
                            <span>
                                <span style="color: #c1ff24" class="message_name">[SERVER]</span>: Debes de tener un tag para usar este chat!
                            </span>
                        </div>
                    `;
                } else {
                    modMessages.innerHTML = `
                        <div class="message">
                            <span>
                                <span style="color: #c1ff24" class="message_name">[SERVER]</span>: Bienvenid@ al Party Chat de Quantum.js!
                            </span>
                        </div>
                    `;
                }
            ...
            menu.innerHTML = `
                ...
                <div class="scroll">
                    ...
                    <div class="csBlock">
                        ...
                        <div class="flex f-column g-5 centerXY" style="padding: 5 5px;">
                        <div class="csBlock">
                        <div class="csBlockTitle">
        ...
        smallMods() {
            ...
            gameTitle.innerHTML = 'Sigmally<span style="display: block; font-size: 14px;  font-family: Poppins, sans-serif;">Mod de <a href="https://www.youtube.com/@danjscode" target="_blank" style="color: #92ef26;">Danjs</a></span>';
            ...
            function updNick() {
                ...
                if (welcome) {
                    welcome.innerHTML = `Bienvenido ${this.nick || "Unnamed"}, a Quanum.js!`;
                }
            }
            ...
            const createNameDiv = (name) => {
               ...
               delName.classList.add("delName");
                ...
                delName.addEventListener("click", () => {
                    if (confirm("¿Estás seguro de que quieres eliminar el nombre: " + nameLabel.innerText + "'?")) {
            ...
            saveNameBtn.addEventListener("click", () => {
                if (saveNameInput.value == "") {
                    ...
                    if (savedNames.includes(saveNameInput.value)) {
                        console.log("¡Ya tienes este nombre guardado!");
                        return;
                    }

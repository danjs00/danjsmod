                        ...
                        <div class="mod_menu_navbar">
                          ...
                          <div class="mod_menu_content">
                            ...
                            <div class="modRowItems" style="background: #121111;height: 50px;">
                                    ...
                                    <div class="modRowItems" style="background: #121111;height: 50px;">
                                        <div class="modItem">
                                            <a href="https://raw.githubusercontent.com/danjs00/danjsmod/main/QuantumEN.js" style="color:#fff;" title='Translate Mod'><span class="text"><svg fill="#4d91ff" width="14" style="margin-right:6px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><title>Translate Mod</title><path d="M349.4 44.6c5.9-13.7 1.5-29.7-10.6-38.5s-28.6-8-39.9 1.8l-256 224c-10 8.8-13.6 22.9-8.9 35.3S50.7 288 64 288H175.5L98.6 467.4c-5.9 13.7-1.5 29.7 10.6 38.5s28.6 8 39.9-1.8l256-224c10-8.8 13.6-22.9 8.9-35.3s-16.6-20.7-30-20.7H272.5L349.4 44.6z"/></svg>English</span></a>
                                            <div class="centerXY">
                                            </div>
                                        </div>
                                        <div class="modItem">
                                            <a href="https://raw.githubusercontent.com/danjs00/danjsmod/main/QuantumES.js" style="color:#fff;" title='Translate page'><span class="text"><svg fill="#4d91ff" width="14" style="margin-right:6px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><title>Translate Mod</title><path d="M349.4 44.6c5.9-13.7 1.5-29.7-10.6-38.5s-28.6-8-39.9 1.8l-256 224c-10 8.8-13.6 22.9-8.9 35.3S50.7 288 64 288H175.5L98.6 467.4c-5.9 13.7-1.5 29.7 10.6 38.5s28.6 8 39.9-1.8l256-224c10-8.8 13.6-22.9 8.9-35.3s-16.6-20.7-30-20.7H272.5L349.4 44.6z"/></svg>Spanish</span></a>
                                            <div class="centerXY">
                                             </div>
                                        </div>
                                    </div>
